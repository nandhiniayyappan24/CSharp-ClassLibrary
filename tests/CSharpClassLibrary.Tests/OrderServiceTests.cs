using CSharpClassLibrary.Services;
using Xunit;

namespace CSharpClassLibrary.Tests;
...
public sealed class OrderServiceTests
{
    ...
    [Fact]
    public void CalculateTotal_AppliesDiscount() => Assert.Equal(180m, _sut.CalculateTotal(2, 100m, 10m));
