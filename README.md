# CSharp Class Library — Monolithic (net45)

Class library monolithic project for **net4.5** targeting **.NET 45** (`net45`).
...
```bash
dotnet msbuild tools/CSharpClassLibrary.Tools/CSharpClassLibrary.Tools.csproj -t:RunTests
```
